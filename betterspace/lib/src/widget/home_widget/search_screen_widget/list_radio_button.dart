    ...
    child: Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Image.asset(
                'assets/image_assets/space_image/coworking_space.png'),
            SizedBox(
        ...
        Row(
          ...
          children: [
            Image.asset(
                'assets/image_assets/space_image/meeting_room.png'),
            SizedBox(
              width: AdaptSize.screenWidth * .012,
            ),
            Column(
        ...
        Row(
          ...
          children: [
            Image.asset(
                'assets/image_assets/space_image/office_building.png'),
            SizedBox(
              width: AdaptSize.screenWidth * .012,
            ),
            Column(
