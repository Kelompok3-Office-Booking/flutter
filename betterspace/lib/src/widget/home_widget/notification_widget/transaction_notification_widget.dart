...
Widget transactionNotificationWidget(BuildContext context) {
  return ListView.builder(
      physics: const BouncingScrollPhysics(),
      itemCount: notificationTransaction.length,
      itemBuilder: (context, index) {
        final NotificationModel transactionNotification = notificationTransaction[index];
        return Card(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  transactionNotification.description,
