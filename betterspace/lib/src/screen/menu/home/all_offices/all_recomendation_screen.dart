        ...
        itemBuilder: (context, index) {
          return horizontalCardHome(
            ...
            officeApproxDistance: locationProvider.posisi != null
              ...
              listOfRecomendationRoom[index].officeLocation.officeLatitude,
              listOfRecomendationRoom[index].officeLocation.officeLongitude,
            )
                : '-',
            officePersonCapacity:
            listOfRecomendationRoom[index].officePersonCapacity.toString(),
            officeArea: listOfRecomendationRoom[index].officeArea.toString(),
            hours: listOfRecomendationRoom[index].officeOpenTime.timeZoneName,
            officePricing:
